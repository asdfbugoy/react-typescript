...
import { REST_CLOUD_PDF_TnC } from 'stores/global';
            ...
            <div className="card shadow mb-3 border">
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col">
                            <p className="m-0 avenirHeavy">I have advised customer on the <a href={REST_CLOUD_PDF_TnC} target="_blank">Design Assumptions</a></p>
                        </div>
                    </div>
                </div>
            </div>
